    ...
    <div class="container mx-auto px-4 py-4 md:py-0  flex justify-between items-center">
        <div class="flex items-center space-x-2">
            <a href="{{ url('/') }}" class="flex items-center space-x-2">
                ...
                <h1 class="text-2xl font-bold text-gray-800">S<span class="text-blue-600">Blog</span></h1>
            </a>
        </div>
        ...
        <nav class="hidden md:flex space-x-8 items-center">
            ...
            <a href="{{url('/profile')}}" class="text-gray-600 hover:text-blue-600 transition">About</a>
            <a href="{{url('/register')}}" class="text-gray-600 hover:text-blue-600 transition">Contact</a>
        </nav>

        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    <img src="{{ asset('Assets/img/img0.png') }}" alt="Web Development" class="w-full h-48 object-cover">
                    <div class="p-6">
                ...
                <!-- Featured Post 2 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    <img src="{{ asset('Assets/img/img1.png') }}" alt="Artificial Intelligence"
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">A beginner's guide to understanding and implementing AI and machine
                            learning concepts.</p>
                        <a href="#" class="text-blue-600 font-medium hover:text-blue-800 transition">Read More</a>
                    </div>
                </div>
                ...
                <!-- Featured Post 3 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    <img src="{{ asset('Assets/img/img2.png') }}" alt="Cloud Computing" class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                        ...
                        <p class="text-gray-600 mb-4">Learn the most effective strategies for leveraging cloud computing in
                            your projects.</p>
                        <a href="#" class="text-blue-600 font-medium hover:text-blue-800 transition">Read More</a>
                    </div>
                </div>
        ...
        <main class="lg:w-2/3">
            ...
            <div class="space-y-8">
                ...
                <article
                    ...
                    <img src="{{ asset('Assets/img/im1.png') }}" alt="React 18" class="md:w-1/3 h-48 md:h-auto object-cover">
                ...
                <article
                    class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition flex flex-col md:flex-row">
                    <img src="{{ asset('Assets/img/img1.png') }}" alt="Cybersecurity"
                ...
                <article
                    class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition flex flex-col md:flex-row">
                    <img src="{{ asset('Assets/img/img0.png') }}" alt="Low-Code Development"
                        class="md:w-1/3 h-48 md:h-auto object-cover">
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                        ...
                        <p class="text-gray-600 mb-4">How low-code platforms are changing the software development landscape
                            and who should use them.</p>
                        <a href="#" class="text-blue-600 font-medium hover:text-blue-800 transition">Read More</a>
                    </div>
                </article>
            </div>
